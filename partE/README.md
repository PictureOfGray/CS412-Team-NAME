...
Clearly, v3 needed to be amended. The main steps of nearest neighbor -> two_opt -> reformat were put in a for loop that runs for 50 times by default. Sound familiar? Well it should -- this is v2.5 but actually functional due to the new randomness and changes. Thus, 3.5 was born.
